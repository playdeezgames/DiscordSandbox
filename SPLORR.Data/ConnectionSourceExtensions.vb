...
WHERE 
    ...
    End Function
    <Extension>
    Function ReadIntegerForInteger(connectionSource As Func(Of SqlConnection), tableName As String, inputField As (Name As String, Value As Integer), outputFieldName As String) As Integer
        Const PARAMETER_INPUT = "@Input"
        Using command = connectionSource().CreateCommand
            command.CommandText = $"
SELECT 
