...
<%
    ...
    StartPage
        ...
        StartInsertForm SubPath
            ...
            StartTable 
                FilteredComboBoxAdd COLUMN_CARD_TYPE_GENERATOR_ID, "Card Type Generator", Conn, VIEW_EFFECT_TYPE_AVAILABLE_CARD_TYPE_GENERATORS, COLUMN_CARD_TYPE_GENERATOR_NAME, COLUMN_EFFECT_TYPE_ID, Request.QueryString, False
