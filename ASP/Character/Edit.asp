    ...
    StartPage
        ...
        StartUpdateForm SubPath
            StartTable 
                ...
                ComboBoxEdit COLUMN_CHARACTER_TYPE_ID, "Character Type", Conn, TABLE_CHARACTER_TYPES, COLUMN_CHARACTER_TYPE_NAME, rs, False
                ComboBoxEdit COLUMN_LOCATION_ID, "Location", Conn, TABLE_LOCATIONS, COLUMN_LOCATION_NAME, rs, False
                SubmitButton 
            EndTable 
        EndForm
        rs.close
