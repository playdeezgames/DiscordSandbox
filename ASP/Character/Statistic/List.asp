...
<%
    ...
    Set rs = ExecuteSelectCommand(conn, _
        ...
        Array(Request.QueryString(COLUMN_CHARACTER_ID)))
    StartTable 
        ShowTableHeaders(Array("Character Statistic Id","Statistic Type Name","Statistic Value","Minimum Value","Maximum Value"))
        do until rs.eof
            StartTableRow
                TableCellEditLink SubPath, COLUMN_CHARACTER_STATISTIC_ID, rs
    ...
    FilterAddLink SubPath, "new statistic", COLUMN_CHARACTER_ID, Request.QueryString
%>
