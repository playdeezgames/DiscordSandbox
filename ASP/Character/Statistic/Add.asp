...
<%
    ...
    StartPage
        ...
        StartInsertForm SubPath
            ...
            StartTable 
                FilteredComboBoxAdd COLUMN_STATISTIC_TYPE_ID, "Statistic Type", Conn, VIEW_CHARACTER_AVAILABLE_STATISTIC_TYPES, COLUMN_STATISTIC_TYPE_NAME, COLUMN_CHARACTER_ID, Request.QueryString, False
